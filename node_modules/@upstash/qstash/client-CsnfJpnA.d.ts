 ...
 */
type MessageCancelFilterFields = UniversalFilterFields & Omit<QStashIdentityFields, "messageId"> & HostPathFilterFields;
/**
...
type LogsListFilters = UniversalFilterFields & Omit<QStashIdentityFields, "messageId"> & HostPathFilterFields & LogsFilterFields & {
    /**
     * @deprecated `api` filter has been removed from the API and will be ignored
     */
    api?: string;
