 ...
 */
declare function isSpoofedBot(result: ArcjetRuleResult): boolean | undefined;
/**
 ...
 *   `undefined` if the rule result was non-bot or `DRY_RUN`.
 */
declare function isVerifiedBot(result: ArcjetRuleResult): boolean | undefined;
/**
 ...
 *   `undefined` if the rule result was non-bot or `DRY_RUN`.
 */
declare function isMissingUserAgent(result: ArcjetRuleResult): boolean | undefined;
//#endregion
